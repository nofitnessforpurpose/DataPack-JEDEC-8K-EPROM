...
<br>  
  Data Packs trypically reside in <a targer="_blank" rel="noopener noreferrer" href="https://github.com/nofitnessforpurpose/DataPak">side slot housings</a> though the circuit is also applicable to the devices Top Slot interface. The circuit presents a Linear mode addressing scheme (though note the effevtive addressing resulting from the pin routing).   <br>
